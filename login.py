...
import torch 
import numpy as np 
from algo import return_books_random,tranform_selected_to_real_rating,updated_user_item_rating,update_userdb_and_profile,hybird_recommendation
app = Flask(__name__)
CORS(app)
...
def generate_recommendations(username):
    ...
    hybird_recommendation_list = hybird_recommendation(username,user_rating_path,user_db,item_lists,item_embeddings,k=10)
    
    return jsonify({
        'recommendation_list': hybird_recommendation_list,
